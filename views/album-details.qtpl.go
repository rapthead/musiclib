...
//line album-details.qtpl:292
		qw422016.N().S(`
                        </td>
                        <td>
                            `)
//line album-details.qtpl:296
		streammakeIntInput(qw422016, intInputConfig{
			label:    "Track number",
			required: true,
